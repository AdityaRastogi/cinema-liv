...
export const SEARCH_API_WITH_TITLE =
  BASE_URL + API_KEY_PARAM + API_KEY + SEARCH_TYPE_MOVIE_PARAM + SEARCH_TITLE_API_PARAM;
export const SEARCH_API_WITH_ID =
  BASE_URL + API_KEY_PARAM + API_KEY + SEARCH_TYPE_MOVIE_PARAM + SEARCH_ID_API_PARAM;
